...
import { DECK_USAGE_KEY, readUsage, writeUsage, editDistance, matchScore, BROWSE_CAP, RESULT_CAP } from './commandDeck/ranking';
import type { UsageEntry } from './commandDeck/ranking';
...
// 2026-09-10 split: usage tracking + relevance scoring live in commandDeck/ranking.ts
// (pure logic, no JSX); this file owns palette state, item assembly, and layout.
