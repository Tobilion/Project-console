...
['run the calculation', 'BUILTIN=system.chit_chat.calculate'],
      ['run your idea', 'BUILTIN=run_project(closeSecond=project.knowledge.commands)'],
...
['extract the archive', 'BUILTIN=project.context.file_count'],
  ...
  },
  {
    ...
    items: [
      ...
      ['show my reminders', 'BUILTIN=system.reminders.list(closeSecond=system.tools.open_reminders)'],
  ...
  },
  {
    ...
    items: [
      ...
      ['show my notes', 'BUILTIN=system.notes.list(closeSecond=system.tools.open_notes)'],
  ...
  },
  {
    ...
    items: [
      ...
      ['clipboard history', 'BUILTIN=clipboard.show(closeSecond=clipboard.clear)'],
  ...
  },
  {
    ...
    items: [
      ...
      ['open documents', 'BUILTIN=system.tools.open_documents(closeSecond=file_read)'],
