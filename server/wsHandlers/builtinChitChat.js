...
export const chitChatHandlers = {
  ...
  // desktop/main.cjs). Runs the exact same console-doctor checks/auto-fixes the CLI's
  // `console doctor --fix` and the K-10 REST routes use — one source of truth for "what's
  // wrong" and "how to fix it" across chat, CLI, REST, and (via the Settings Diagnostics
  // panel once built) the UI. Reached either by the user directly asking ("troubleshoot",
