...
export const NPM_AND_FILE_INTENTS = {
  'npm_install': {
    examples: [
      ...
      'heyy, install everything from package.json',
      'fetc dependencies',
      'Dependencies ftch so',
      'can you install a packagt 🙏',
      'install packjges',
      'heyy, install everything from package.json please',
      'INSTALL THE PACKAGSE',
      'installed packaegs all get'
      ],
  },
  'npm_build': {
    examples: [
  ...
  'npm_run': {
    examples: [
      ...
      'yo script run please',
      'ehy, npm launch',
      'dev server the run so',
      'a script run asap um',
      'hey fire up in dev mode quickly',
      'hey, fire up npm command thanks',
      'bire up dev'
      ],
  },
  'file_create': {
  ...
  'file_read': {
    examples: [
      ...
      'um can you tell me me this file',
      'Open thir file 🙏',
      'prnit the doc',
      'please open this file',
      'WHAT ARE THE CONTENTS OF',
      'Read the contents of quickly :p',
      'this peek at doc',
      'open file :)',
      'read document',
      'yo open file 🙏',
      'yo open this file now',
      'this read you can document',
      'show thanks um doc the me...',
      'VIEW THE DOCUMENT',
      'cat htis document',
      'Tell me me whats insidm :)',
      'HEY, OPEN FILE',
      'Open document',
      'pint the file :)',
      'so open file',
      ...
      'Could you open doc for me',
      'hey, take a look at this document',
      'ptease read this file quickly...',
      'file this open'
      ],
  },
  'file_append': {
    examples: [
      ...
      'So note a add the to file',
      'append text to the file now :p',
      'PLEASE ADD TO THE END OF THE FILE',
      'add to the end of the file 🙏',
      'to document line the a add',
      'tack this otno the doc',
      'please add to the bottom of the file',
      'add on to the file for me :p',
      'add hey, to on document the',
      'to append hey file',
      'please add a jot down to the file thanks',
      'add a meemo to the file',
      'to this the file append',
      'yo add to the bottom of the file',
      'Add a jot down to the file',
      'add to the end of the file!',
      'HEY, ADD TO THE END OF THE FILE',
      'ile the onto this tack hi,',
      'can you add to the end of the file',
      'APPEND TO DOCUMENT',
      'hey, add another line to the document!',
      'could you add to the bottom of the file',
      'Add to the bottom of the file thanks',
      'hi, add to the end of the file',
      'can you appetd text to the doc'
      ],
  },
  'file_delete': {
    examples: [
  ...
  'file_find': {
    ...
    examples: [
      ...
      'wfere does this doc live',
      'yo the search for document',
      'file the called asap find',
      'setup fie the is where',
      'could is fil where you setup the',
      'finw the file called please',
      'locate the config document',
      'so find a doc called :p'
      ],
  },
  'run_tests': {
    ...
    examples: [
      ...
      'hi, run the test docs',
      'up test the suite fire',
      'Start pyetst now',
      'yo can you execute the tests asap',
      'can you fire up the test suite now now',
      'Tests now run the',
      'so fire up the whole test suite',
      'now launch hey tests the all...',
      'can you fire up the tests',
      'now run pytest um for me',
      'my launch um tests again',
      'the run hi, tests will you',
      'um start the test suite now',
      'ftles the hi, test launch',
      'hey, frie up my tests',
      'the all you can run tests',
      'run the test whle suite quickly',
      'can you fire up the tests thanks',
      'yo can you run the tsets',
      'execute all the tests',
      'yo the please run tests',
      'um please launch the kests',
      'please run the etsts 🙏',
      'Pytets run so :)',
      'please execute the pytest suite please',
      'up tests fire the hey, failing',
      'execute all the tests for me',
      'yo start the test suite'
      ],
  },
};
