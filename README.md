...
- **"how do I run/do X"**: the `how_to_run` answer always lists every exact `console.config.json` command entry (with param names), not just whatever the README happens to document.
